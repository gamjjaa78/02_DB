...
CREATE TABLE PRODUCTS(
	...
	--CATEGORY NUMBER CONSTRAINT CATEGORIES_FK REFERENCES CATEGORIES(CATEGORY_ID),
	--제약조건명을 CATEGORIES_FK로 만듦, 바꿔도 됨
...
CUSTOMER_ID NUMBER REFERENCES CUSTOMERS(CUSTOMER_ID) --PK키
--CUSTOMER_ID NUMBER CONSTRAINT CUSTOMERS_FK REFERENCES CUSTOMERS(CUSTOMER_ID) 
ON DELETE CASCADE --부모행이 사라지면 자식행도 사라짐
);
...
--ORDER_ID NUMBER CONSTRAINT ORDERS_FK REFERENCES ORDERS(ORDER_ID) 
ON DELETE CASCADE,
PRODUCT_ID NUMBER REFERENCES PRODUCTS(PRODUCT_ID) 
--PRODUCT_ID NUMBER CONSTRAINT PRODUCTS_FK REFERENCES PRODUCTS(PRODUCT_ID) 
ON DELETE SET NULL,
QUANTITY NUMBER,
...
INSERT INTO PRODUCTS VALUES (201,'LG OLED TV',1,3600000,10);
INSERT INTO PRODUCTS VALUES (301,'Sony PlayStion5',1,700000,15);
...
--INSERT INTO ORDERS VALUES (499,TO_DATE('2020-01-03', 'YYYY-MM-DD'),'Y',1);
SELECT * FROM ORDERS;
...
--→ 유관순 주문일 시간은 무시, 2024-03-11 00:00:00.000 로 조회되도 됩니다!
