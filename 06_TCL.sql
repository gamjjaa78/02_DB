...
--SP2 지점까지 롤백
ROLLBACK TO "SP2"; -- 개발6팀만 삭제, SP2 지점 전 개발5팀까지 있었으므로

--SP1 지점까지 롤백
ROLLBACK TO "SP1"; -- 개발5팀만 삭제, SP2 지점 전 개발4팀까지 있었으므로

--롤백 수행
ROLLBACK; --마지막 커밋 시점, 개발4팀까지 삭제, 개발3팀까지 남음